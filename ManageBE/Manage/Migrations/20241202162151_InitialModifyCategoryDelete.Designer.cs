...
namespace Manage.Migrations
{
    ...
    [Migration("20241202162151_InitialModifyCategoryDelete")]
    partial class InitialModifyCategoryDelete
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Manage.Models.CategoriaDocumenti", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DataInserimentoCategoria = new DateTime(2024, 12, 2, 17, 21, 51, 173, DateTimeKind.Local).AddTicks(3912),
                        ...
                        {
                            Id = 2,
                            DataInserimentoCategoria = new DateTime(2024, 12, 2, 17, 21, 51, 173, DateTimeKind.Local).AddTicks(4014),
            ...
            modelBuilder.Entity("Manage.Models.Documenti", b =>
                {
                    ...
                    b.Property<int?>("SottoCategoriaDocumentiId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SottoCategoriaDocumentiId");
            ...
            modelBuilder.Entity("Manage.Models.SottoCategoriaDocumenti", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime>("DataInserimentoSottoCategoria")
                        .HasColumnType("datetime(6)");

                    b.Property<string>("DescrizioneSottoCategoria")
                        .IsRequired()
                        .HasColumnType("longtext");

                    b.Property<string>("NomeSottoCategoria")
                        .IsRequired()
                        .HasColumnType("longtext");
                    ...
                    b.ToTable("SottoCategoriaDocumenti");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DataInserimentoSottoCategoria = new DateTime(2024, 12, 2, 17, 21, 51, 173, DateTimeKind.Local).AddTicks(4351),
                        ...
                        new
                        {
                            Id = 2,
                            CategoriaDocumentiId = 1,
                            DataInserimentoSottoCategoria = new DateTime(2024, 12, 2, 17, 21, 51, 173, DateTimeKind.Local).AddTicks(4451),
                        ...
                        new
                        {
                            ...
                            DataInserimentoSottoCategoria = new DateTime(2024, 12, 2, 17, 21, 51, 173, DateTimeKind.Local).AddTicks(4551),
                        ...
                        new
                        {
                            Id = 4,
                            CategoriaDocumentiId = 2,
                            DataInserimentoSottoCategoria = new DateTime(2024, 12, 2, 17, 21, 51, 173, DateTimeKind.Local).AddTicks(4659),
            ...
            modelBuilder.Entity("Manage.Models.Documenti", b =>
                {
                    ...
                    b.HasOne("Manage.Models.SottoCategoriaDocumenti", "SottoCategoria")
                        .WithMany("Documenti")
                        .HasForeignKey("SottoCategoriaDocumentiId");
            ...
            modelBuilder.Entity("Manage.Models.SottoCategoriaDocumenti", b =>
                {
                    b.HasOne("Manage.Models.CategoriaDocumenti", "CategoriaDocumenti")
                        .WithMany("SottoCategorie")
                        .HasForeignKey("CategoriaDocumentiId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("CategoriaDocumenti");
                });
